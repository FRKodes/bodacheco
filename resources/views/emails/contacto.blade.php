    ...
    <tbody>
        ...
        <td align='left' bgcolor='#ffffff' style='text-align:center;'>
            <table width='700' height='300' bgcolor='#000' cellpadding='0' cellspacing='0'>
                <tbody>
                <tr height='100'><td bgcolor='#825126' style='color:#FFFFFF;font-size:large' colspan='3'>BODA #CHECOYFLACA</td></tr>
                <tr height='400'>
                    <td bgcolor='#fff' style='border-left:1px solid #825126;border-right:1px solid #825126;'>
                    <table style='font-family:sans-serif, Arial, Helvetica'>
                        ...
                        <td style='text-align:left'>
                            ...
                            <p><b>Confirma Asistencia:  {{ Input::get('c') }} </b></p>
                        </td>
                        <td width='10'></td>
                        </tr>
                        </tbody>
