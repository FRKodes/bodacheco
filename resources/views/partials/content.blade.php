<section id="inicio">
	...
	<div class="container-fluid hoteles">
		...
		<div class="col-md-4 text-center">
			<h3><a class="black" href="http://www.hoteldemetria.com/" target="_blank">Hotel Demetria</a></h3>
			<p>&nbsp;</p>
		</div>
		<div class="col-md-4 text-center">
			<h3><a class="black" href="http://www.casafayette.com/" target="_blank">Casa Fayette</a></h3>
			<p>Referencia: "BODA CHECO & FLACA"</p>
		</div>
		<div class="col-md-4 text-center">
			<h3><a class="black" href="http://www.fiestamericanagrand.com/es/web/grand-fiesta-americana-guadalajara-country-club" target="_blank">Fiesta Americana</a></h3>
